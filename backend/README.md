...
## Project Structure
    ...
    ├── tst_app_generation__51614  # Django project configurations
...
1. Clone this repo and `cd tst_app_generation__51614`
...
2. Clone this repo and `cd tst_app_generation__51614`
